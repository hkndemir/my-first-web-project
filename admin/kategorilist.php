            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">KATEGORİ LİSTESİ</h3>
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2 mt-5 pt-4">
                                        ...
                                        ?>
                                            ...
                                            <input type="checkbox" class="switch-input" onchange="ChangeStatus(<?php echo $listele['id']; ?>);" <?php if($listele['status']==1){?> checked <?php } ?>>
                      ...
                      <span class="switch-handle"></span>
                                            ...
                                            <td></td>
                                                <td> 
                                                    ...
                                                    <a href="kategoriekle.php?id=<?php echo $listele['id']; ?>">
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                            <i class="zmdi zmdi-edit"></i>
                                                        </button></a>
                                                        <a href="sil.php?idE=<?php echo $listele['id']; ?>"> <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
...
function ChangeStatus(ids)
{
    $.ajax({
        url: "g.php",
        method: "POST",
        data: { id: ids, isset: "statusGuncele" },
        success: function (ret)
        {
            if(ret == "true")
            {
                alert("Durum Değiştirilmiştir.");
            }
            else
            {
