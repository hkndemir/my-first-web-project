                            ...
                            <div class="col-lg">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <input type="hidden" name="isset" value="form">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="isim" name="isim" placeholder="Ürün Adını Giriniz" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-md-9">
                                                    ...
                                                    <?php 
                                                     $oku=mysqli_query($conn, "select * from kategoriler");
                                                     while($listele1=mysqli_fetch_array($oku)){
                                                         ?>
                                                         <option value=" <?php echo $listele1['id']; ?>"><?php echo $listele1['adi']; ?></option>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="aciklama" id="textarea-input" rows="9" placeholder="Content..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="text-input" name="stok" placeholder="Ürün Stoğunu Giriniz" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="text-input" name="alis" placeholder="Ürün Alış Fiyatını Giriniz" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number" id="text-input" name="satis" placeholder="Ürün Satış Fiyatını Giriniz" class="form-control">
                                            ...
                                            <div class="row form-group ml-1">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" id="resim" name="resim" placeholder="Ürün Resmi Yükleyiniz" class="form-control">
                                                </div>
                                            </div>
